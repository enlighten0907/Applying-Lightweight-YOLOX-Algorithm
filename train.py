...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'logs/ep500-loss2.228-val_loss2.347.pth'#logs/log_siou/xECA/ep300-loss1.784-val_loss1.803.pth'#'logs/log_siou/ep380-loss2.129-val_loss2.012.pth'#'logs/ep010-loss1.703-val_loss1.780.pth'
    #------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    save_dir            = 'logs/log_siou/xGSConv'
    #------------------------------------------------------------------#
